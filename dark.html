...
<body class="h-screen overflow-hidden text-sm relative">
            ...
            <div class="flex-1 overflow-y-auto p-4 md:p-6 scroll-smooth" id="mainContainer">
                ...
                <section id="pos" class="hidden h-full flex flex-col md:flex-row gap-4 pb-20 md:pb-0">
                    ...
                    <div class="w-full md:w-2/3 flex flex-col gap-4 h-auto md:h-full order-2 md:order-1">
                        <div class="bg-karta-surface p-3 rounded-lg border border-karta-border flex flex-col md:flex-row items-center gap-3">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="w-24">
                                    <input type="number" id="posQtyInput" value="1" min="1" class="input-field text-center h-10" placeholder="Qty">
                                </div>
                                ...
                                <div class="flex items-center bg-gray-800/30 px-2 py-1 rounded border border-gray-700">
                                    ...
                                    <input type="date" id="posManualDate" class="bg-transparent text-xs text-gray-200 focus:outline-none" title="Optional: set a custom date for this invoice">
                                </div>
                            </div>
                        </div>
                        <div class="flex-1 md:overflow-y-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 content-start pr-1 min-h-[300px] auto-rows-max" id="posGrid">
                            <!-- Products JS -->
                        </div>
                    </div>
                    ...
                    <div class="w-full md:w-1/3 bg-karta-surface border border-karta-border rounded-lg flex flex-col h-auto md:h-full order-1 md:order-2 shrink-0">
                        <div class="p-3 border-b border-karta-border">
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                <div class="flex items-center gap-1 flex-1">
                                    <input type="number" id="posFreight" value="0" min="0" step="0.01" class="input-field text-right text-xs" onchange="renderCart()" onkeyup="renderCart()" placeholder="Transport cost">
                        ...
                        <!-- EDIT PRICE MODAL -->
                        <div id="editPriceModal" class="hidden modal-content bg-karta-surface border border-karta-border p-6 rounded-lg w-full max-w-sm">
                            ...
                            <div class="bg-white/5 p-3 rounded mb-4 border border-gray-700">
                                <div class="text-sm text-gray-400 mb-1">Product: <span id="editPriceItemName" class="text-white font-bold">-</span></div>
                                <div class="text-sm text-gray-400">Original Price: <span id="editPriceOriginal" class="text-yellow-400 font-bold">-</span></div>
                            </div>
                            <div class="space-y-3 mb-6">
                                <div>
                                    <label class="text-xs text-gray-400 font-bold block mb-2">Retail Price</label>
                                    <input type="number" id="editPriceInput" class="input-field w-full" min="0" step="0.01" placeholder="Enter retail price">
                                </div>
                                <div>
                                    <label class="text-xs text-gray-400 font-bold block mb-2">Wholesale Price</label>
                                    <input type="number" id="editPriceWholesaleInput" class="input-field w-full" min="0" step="0.01" placeholder="Enter wholesale price">
                                </div>
                            </div>
                            <div class="flex gap-3 justify-end">
                                ...
                                <button type="button" onclick="applyEditPrice()" class="px-4 py-2 bg-karta-primary hover:bg-green-600 text-black font-bold rounded text-sm transition"><i class="fa-solid fa-save mr-1"></i>Save Price</button>
                            </div>
                        </div>
                ...
                <section id="invoices" class="hidden space-y-6 pb-20 md:pb-0">
                    ...
                    <div class="flex gap-2 mb-4 border-b border-gray-800">
                        <button onclick="switchInvoiceTab('sales')" id="tabSalesInv" class="px-4 py-3 font-bold text-sm border-b-2 border-karta-primary text-karta-primary transition-all">
                            <i class="fa-solid fa-receipt mr-2"></i>Sales Invoices
                        </button>
                        <button onclick="switchInvoiceTab('purchase')" id="tabPurchaseInv" class="px-4 py-3 font-bold text-sm border-b-2 border-transparent text-gray-400 hover:text-white transition-all">
                            <i class="fa-solid fa-file-invoice mr-2"></i>Purchase Invoices
                        </button>
                        <button onclick="switchInvoiceTab('settlement')" id="tabSettlement" class="px-4 py-3 font-bold text-sm border-b-2 border-transparent text-gray-400 hover:text-white transition-all">
                    ...
                    <div id="tabContentPurchase" class="space-y-6 hidden">
                        <div class="flex flex-col gap-4">
                            <div class="flex flex-col md:flex-row gap-3 items-stretch md:items-end">
                                <input type="date" id="purchInvFromDate" class="input-field flex-1 md:w-48" placeholder="From Date" title="Filter from this date">
                                <input type="date" id="purchInvToDate" class="input-field flex-1 md:w-48" placeholder="To Date" title="Filter to this date">
                                <button onclick="filterPurchaseInvoices()" class="flex-1 md:flex-none bg-karta-primary hover:bg-karta-primaryDark text-black px-4 py-2 rounded font-bold text-xs transition-all"><i class="fa-solid fa-filter mr-1"></i>Filter</button>
                                <button onclick="clearPurchaseFilters()" class="flex-1 md:flex-none bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded font-bold text-xs whitespace-nowrap">Clear All</button>
                            </div>
                        </div>
                        <div class="bg-karta-surface border border-karta-border rounded-lg overflow-hidden">
                            <div class="table-container">
                    ...
                    <div id="tabContentSettlement" class="space-y-6 hidden">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                            <div class="bg-karta-surface border border-karta-border p-4 rounded-lg">
                                <div class="text-gray-400 text-sm mb-1 flex items-center gap-2"><i class="fa-solid fa-handshake"></i> Total Settlements</div>
                                <div class="text-3xl font-bold text-karta-primary" id="settlementCount">0</div>
                            </div>
                            <div class="bg-karta-surface border border-karta-border p-4 rounded-lg">
                                <div class="text-gray-400 text-sm mb-1 flex items-center gap-2"><i class="fa-solid fa-money-bill"></i> Cash Settled</div>
                                <div class="text-3xl font-bold text-green-500" id="settlementCashTotal">$0</div>
                            </div>
                            <div class="bg-karta-surface border border-karta-border p-4 rounded-lg">
                                <div class="text-gray-400 text-sm mb-1 flex items-center gap-2"><i class="fa-solid fa-building"></i> Bank Settled</div>
                                <div class="text-3xl font-bold text-blue-500" id="settlementBankTotal">$0</div>
                            </div>
                            <div class="bg-karta-surface border border-karta-border p-4 rounded-lg">
                                <div class="text-gray-400 text-sm mb-1 flex items-center gap-2"><i class="fa-solid fa-receipt"></i> Pending</div>
                        ...
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                            <div class="flex gap-2 flex-col md:flex-row w-full md:w-auto">
                                <input type="text" id="settlementSearch" placeholder="Search by Customer/Supplier name..." class="input-field w-full md:w-96" oninput="renderSettlements()">
                                <select id="settlementTypeFilter" class="input-field w-full md:w-48" onchange="renderSettlements()">
                            ...
                            <div class="flex gap-2 w-full md:w-auto">
                                <button onclick="renderSettlements()" class="flex-1 md:flex-none bg-gray-700 text-white px-4 py-2 rounded font-bold hover:bg-gray-600 transition flex items-center justify-center gap-2" title="Refresh settlements list">
                                    <i class="fa-solid fa-refresh"></i> Refresh
                                </button>
                                <button onclick="openModal('newSettlementModal')" class="flex-1 md:flex-none bg-karta-primary text-black px-4 py-2 rounded font-bold hover:bg-karta-primaryDark transition flex items-center justify-center gap-2">
                        ...
                        <div class="bg-karta-surface border border-karta-border rounded-lg p-4 flex flex-col h-full">
                            ...
                            <div class="border-t border-gray-700 mt-3 pt-3">
                                ...
                                <div class="bg-white/5 p-2 rounded border border-gray-700 mb-3 space-y-1">
                                    ...
                                    <div class="flex justify-between text-sm text-gray-300 border-t border-gray-600 pt-1">
                                ...
                                <div id="retCustSplitDiv" class="hidden bg-white/5 p-3 rounded border border-karta-border space-y-2">
                                    ...
                                    <div class="flex gap-1">
                                        <div class="flex-1">
                                            ...
                                            <input type="number" id="retCustSplitCash" class="input-field text-xs" placeholder="0" min="0" step="0.01" onchange="autoCalculateSplitCust()">
                                        </div>
                                        <div class="flex-1">
                                            <label class="text-xs text-gray-500">Bank</label>
                                            <input type="number" id="retCustSplitBank" class="input-field text-xs" placeholder="0" min="0" step="0.01" onchange="autoCalculateSplitCust()">
                                        </div>
                                        <div class="flex-1">
                                            <label class="text-xs text-gray-500">Credit</label>
                                            <input type="number" id="retCustSplitCredit" class="input-field text-xs" placeholder="0" min="0" step="0.01" onchange="autoCalculateSplitCust()">
                                        </div>
                                    </div>
                                    <div class="flex justify-between text-xs text-gray-400">
                                        <span>Total:</span>
                            ...
                            <div class="border-t border-gray-700 mt-3 pt-3">
                                ...
                                <div id="retSupSplitDiv" class="hidden bg-white/5 p-3 rounded border border-karta-border space-y-2">
                                    ...
                                    <div class="flex gap-1">
                                        <div class="flex-1">
                                            <label class="text-xs text-gray-500">Cash</label>
                                            <input type="number" id="retSupSplitCash" class="input-field text-xs" placeholder="0" min="0" step="0.01" onchange="autoCalculateSplitSup()">
                                        </div>
                                        <div class="flex-1">
                                            <label class="text-xs text-gray-500">Bank</label>
                                            <input type="number" id="retSupSplitBank" class="input-field text-xs" placeholder="0" min="0" step="0.01" onchange="autoCalculateSplitSup()">
                                        </div>
                                        <div class="flex-1">
                                            <label class="text-xs text-gray-500">Credit</label>
                                            <input type="number" id="retSupSplitCredit" class="input-field text-xs" placeholder="0" min="0" step="0.01" onchange="autoCalculateSplitSup()">
                                        </div>
                                    </div>
                                    <div class="flex justify-between text-xs text-gray-400">
                                        <span>Total:</span>
                    ...
                    <div class="bg-karta-surface border border-karta-border rounded-lg p-6">
                        ...
                        <form id="settingsForm" class="space-y-4">
                             ...
                             <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Select your business type for better organization and compliance.</p>
                            </div>
                        ...
                        <div class="mt-10 pt-6 border-t border-gray-700 space-y-4">
                            ...
                            <div class="p-4 bg-white/5 rounded border border-gray-700 mb-4">
                                <h5 class="text-karta-primary font-bold mb-2"><i class="fa-solid fa-receipt"></i> Sales Invoice Numbering</h5>
                                <p class="text-xs text-gray-400 mb-3">Control how your sales invoices are numbered.</p>
                                
                                <div class="space-y-3">
                                    <div>
                                        <label class="block text-xs text-gray-400 mb-2">Current Invoice Number</label>
                                        <div class="flex items-center gap-2">
                                            <input type="text" id="currentInvoiceNumber" class="input-field flex-1" readonly>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        <div>
                                            <label class="block text-xs text-gray-400 mb-2">Reset Starting Number</label>
                                            <input type="number" id="invoiceStartNumber" class="input-field" placeholder="e.g., 1001" value="1">
                                        </div>
                                        <div class="flex items-end">
                                            <button type="button" onclick="resetInvoiceNumbering()" class="w-full bg-orange-700 text-white px-4 py-2 rounded text-xs hover:bg-orange-600 text-center">
                                                <i class="fa-solid fa-redo"></i> Reset & Start Fresh
                                            </button>
                                        </div>
                                    </div>
                                    
                                    <div class="flex items-center gap-2 p-2 bg-blue-900/20 rounded border border-blue-700/50">
                                        <input type="checkbox" id="autoInvoiceNumber" class="w-4 h-4" checked>
                                        <label for="autoInvoiceNumber" class="text-xs text-gray-300 cursor-pointer">Auto-increment invoice numbers (recommended)</label>
                                    </div>
                                    
                                    <p class="text-xs text-gray-500 mt-2">
                                        <i class="fa-solid fa-info-circle"></i> Next invoice will be #<span id="nextInvoicePreview">1</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col md:flex-row gap-4">
                                ...
                                <button onclick="repairCashAndBankBalances()" class="bg-orange-700 text-white px-4 py-2 rounded text-xs hover:bg-orange-600 text-center"><i class="fa-solid fa-wrench"></i> Repair Balances</button>
                            </div>
                            <div class="mt-4">
    ...
    <div id="modalBackdrop" onclick="if(event.target === this) closeModal();" class="fixed inset-0 bg-black/80 backdrop-blur-sm hidden z-50 flex items-center justify-center p-4">
        ...
        <div id="supModal" class="hidden modal-content bg-karta-surface border border-karta-border p-6 rounded-lg w-full max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <form id="supForm" class="space-y-4">
                ...
                <div class="form-group">
                    ...
                    <span class="help-text">Outstanding balance payable to this supplier. Can be manually adjusted if needed.</span>
                </div>
                <div class="flex justify-end gap-2 mt-6">
                    <button type="button" onclick="closeModal()" class="px-4 py-2 bg-gray-700 rounded text-white hover:bg-gray-600 transition">Cancel</button>
                    <button type="button" id="fixBalanceBtn" onclick="fixSupplierBalance()" class="px-4 py-2 bg-orange-700 text-white rounded hover:bg-orange-600 transition hidden"><i class="fa-solid fa-wrench mr-2"></i>Fix Negative Balance</button>
         ...
         <div id="purchModal" class="hidden modal-content bg-karta-surface border border-karta-border p-6 rounded-lg w-full max-w-5xl max-h-[90vh] overflow-y-auto">
            ...
            <form id="purchForm" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label class="text-xs font-bold text-gray-400 mb-2 block uppercase tracking-wide">📅 Purchase Date</label>
                    ...
                    <div>
                        <label class="text-xs font-bold text-gray-400 mb-2 block uppercase tracking-wide">📋 Supplier Invoice #</label>
                        <input type="text" id="supplierInvoiceNumber" class="input-field w-full" placeholder="e.g., INV-2025-001" required>
                ...
                <div class="border-t border-karta-border pt-4">
                    <label class="text-xs font-bold text-gray-400 mb-3 block uppercase tracking-wide">🏷️ Discount (Optional)</label>
                    <div class="flex gap-2 items-center max-w-xs">
                        <label class="text-xs text-gray-400 flex-1">Discount %</label>
                        <div class="flex items-center gap-1 flex-1">
                            <input type="number" id="purchDiscount" value="0" min="0" max="100" step="0.1" class="input-field text-right text-xs" onchange="renderPurchaseItems()" onkeyup="renderPurchaseItems()">
                            <span class="text-xs text-gray-400">%</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-karta-border pt-4">
                    ...
                    <div class="grid grid-cols-4 gap-3 mb-4">
                        ...
                        <label class="flex items-center justify-center px-4 py-3 rounded border-2 border-karta-border hover:bg-white/5 text-white cursor-pointer transition" title="Bank transfer/cheque - Reduces bank balance">
                            <input type="radio" name="purchPayment" value="bank" class="mr-2" onchange="updatePaymentDisplay()"> 
                        ...
                        <label class="flex items-center justify-center px-4 py-3 rounded border-2 border-karta-border hover:bg-white/5 text-white cursor-pointer transition" title="Split payment - Part cash, bank, and/or credit">
                    ...
                    <div id="splitPaymentSection" class="hidden bg-white/5 p-4 rounded border border-karta-border mb-4">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <div>
                                ...
                                <input type="number" id="splitBankAmount" class="input-field" placeholder="0.00" step="0.01" min="0" oninput="calculateSplitCredit()">
                            </div>
                            <div>
                        ...
                        <div class="mt-3 p-3 bg-blue-900/20 border border-blue-800 rounded text-xs text-blue-300">
                            ...
                            Grand Total: <span id="splitTotalDisplay" class="font-bold">$0.00</span> | Cash: <span id="splitCashDisplay" class="font-bold text-green-400">$0.00</span> | Bank: <span id="splitBankDisplay" class="font-bold text-blue-400">$0.00</span> | Credit: <span id="splitCreditDisplay" class="font-bold text-yellow-400">$0.00</span>
                        </div>
                    </div>
                </div>
         ...
         <div id="expModal" class="hidden modal-content bg-karta-surface border border-karta-border p-6 rounded-lg w-full max-w-sm">
            ...
            <form id="expForm" class="space-y-4">
                ...
                <div class="form-group">
                    <label class="text-xs text-gray-400 font-bold">Payment Mode <span class="text-red-500">*</span></label>
                    <div class="flex gap-2 mt-2">
                        <label class="flex items-center gap-2 px-3 py-2 rounded border-2 border-karta-border hover:bg-white/5 cursor-pointer transition" title="Deduct from cash">
                            <input type="radio" name="expPayment" value="cash" checked class="cursor-pointer"> 
                            <span class="text-xs">Cash</span>
                        </label>
                        <label class="flex items-center gap-2 px-3 py-2 rounded border-2 border-karta-border hover:bg-white/5 cursor-pointer transition" title="Deduct from bank">
        ...
        <div id="newSettlementModal" class="hidden modal-content bg-karta-surface border border-karta-border p-6 rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <h3 class="text-xl font-bold mb-6 text-white"><i class="fa-solid fa-handshake mr-2 text-karta-primary"></i>New Credit Settlement</h3>
            ...
            <form id="settlementForm" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="flex items-center justify-center px-4 py-3 rounded border-2 border-karta-border bg-karta-primary/20 text-karta-primary cursor-pointer transition hover:bg-karta-primary/40">
                            <input type="radio" name="settlementType" value="customer" checked onchange="loadSettlementEntities()" class="mr-2"> 
                            <span class="font-bold"><i class="fa-solid fa-user mr-1"></i>Customer Due</span>
                        </label>
                        <label class="flex items-center justify-center px-4 py-3 rounded border-2 border-karta-border hover:bg-white/5 text-white cursor-pointer transition">
                            <input type="radio" name="settlementType" value="supplier" onchange="loadSettlementEntities()" class="mr-2"> 
                ...
                <div>
                    ...
                    <input type="number" id="settlementAmount" class="input-field text-lg font-bold" placeholder="0.00" step="0.01" onchange="updateSettlementDisplay()" oninput="updateSettlementDisplay()" required>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="flex items-center justify-center px-4 py-3 rounded border-2 border-karta-border bg-green-900/20 text-green-400 cursor-pointer transition hover:bg-green-900/40">
                            <input type="radio" name="settlementPayment" value="cash" checked onchange="toggleChequeInput()" class="mr-2"> 
                            <span class="font-bold"><i class="fa-solid fa-money-bill mr-1"></i>Cash</span>
                        </label>
                        <label class="flex items-center justify-center px-4 py-3 rounded border-2 border-karta-border hover:bg-white/5 text-white cursor-pointer transition">
                            <input type="radio" name="settlementPayment" value="bank" onchange="toggleChequeInput()" class="mr-2"> 
                ...
                <div id="chequeDetailsDiv" class="hidden space-y-3 bg-blue-900/20 p-4 rounded border border-blue-800">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" id="settlementChequeNo" class="input-field" placeholder="e.g., CHQ-123456">
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="settlementBankName" class="input-field" placeholder="e.g., Nepal Bank Ltd">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea id="settlementNotes" class="input-field" placeholder="e.g., Payment received via..." rows="2"></textarea>
                </div>

                <!-- Action Buttons -->
                <div class="flex justify-end gap-2 pt-4 border-t border-gray-700">
                    <button type="button" onclick="closeModal()" class="px-4 py-2 bg-gray-700 rounded text-white hover:bg-gray-600 transition">Cancel</button>
                    <button type="submit" class="px-4 py-2 bg-karta-primary text-black font-bold rounded hover:bg-karta-primaryDark transition flex items-center gap-2">
        ...
        <div id="settlementViewModal" class="hidden modal-content bg-karta-surface border border-karta-border p-6 rounded-lg w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            <div class="flex justify-between items-start mb-6">
                <h3 class="text-xl font-bold text-white">Settlement Invoice</h3>
                <div class="flex gap-2">
                    <button onclick="printSettlementInvoice()" class="bg-white text-black px-4 py-2 rounded font-bold text-xs hover:bg-gray-200 transition flex items-center gap-2">
                        <i class="fa-solid fa-print"></i> Print
                    </button>
                    <button onclick="downloadSettlementPDF()" class="bg-green-600 text-white px-4 py-2 rounded font-bold text-xs hover:bg-green-700 transition flex items-center gap-2">
                        <i class="fa-solid fa-file-pdf"></i> PDF
                    </button>
                    <button onclick="closeModal()" class="bg-gray-700 text-white px-4 py-2 rounded font-bold text-xs hover:bg-gray-600 transition">Close</button>
                </div>
            </div>
        ...
        <div id="invoice-print-view" style="font-family: Arial, sans-serif; color: #000; background: white; padding: 0;">
            ...
            <div style="border: 2px solid #000; padding: 20px; width: 100%; box-sizing: border-box;">
                ...
                <div style="border-bottom: 2px solid #000; padding-bottom: 12px; margin-bottom: 15px;">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                        ...
                        <div style="display: flex; gap: 12px; flex: 1;">
                            ...
                            <div>
                                <h1 style="font-size: 22px; font-weight: bold; margin: 0; color: #000;" id="invCompName">KARTA BUSINESS</h1>
                        ...
                        <div style="text-align: center; border-left: 2px solid #000; padding-left: 15px;">
                            <h2 style="font-size: 24px; font-weight: bold; color: #000; margin: 0;" id="invTitle">TAX INVOICE</h2>
                    ...
                    <table style="width: 100%; border-collapse: collapse; font-size: 12px;">
                        ...
                        <tr style="background: #ffeb99; border-bottom: 2px solid #000;">
                            <td colspan="2" style="padding: 10px; font-weight: bold; font-size: 11px;">
                                <strong>Amount in Words:</strong> <span id="invTotalWords" style="font-weight: normal; font-style: italic;">Zero Only</span>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div style="border: 1px solid #000; padding: 10px; margin-bottom: 15px; font-size: 11px;">
                    ...
                    <p id="invFreightRow" style="margin: 0 0 5px 0; display: none;"><strong>Freight Charge:</strong> <span id="invFreight">0.00</span></p>
                ...
                <div style="margin-top: 15px; text-align: center; font-size: 10px; border-top: 1px solid #000; padding-top: 10px;">
                    <p style="margin: 3px 0;">This is a Computer Generated Invoice. Authorized signatory is not required.</p>
...
Updated Balances:
    ...
    Bank: ${db.config.currency}${db.config.bankBalance.toFixed(2)}`);
        ...
        document.getElementById('purchForm').onsubmit = e => {
            ...
            let totalVAT = 0;
            const txnItems = [];
            const purchaseDate = new Date(purchaseDateInput).toISOString().split('T')[0];
            ...
            displayProducts.filter(p => {
                ...
                el.innerHTML = `
                    ...
                    <div class="text-xs text-gray-400 space-y-1 mb-3 border-t border-gray-700 pt-2">
                        ...
                        <div><span class="text-gray-500">Expires:</span> <span class="${p.expiry && p.expiry !== 'N/A' ? 'text-yellow-400 font-semibold' : 'text-gray-500'}">${p.expiry || 'N/A'}</span></div>
                    </div>
        ...
        window.processReturn = function(mode) {
            if(mode === 'cust') {
                ...
                // Determine original payment method from customer's most recent non-return sale
                ...
                // Get refund method from selected radio button (or use original payment method)
                ...
                if(refundMethod === 'cash') {
                    ...
                    // We owe customer - customer credit balance INCREASES
                    if(!isWalkin && cust) {
                        cust.balance = moneyRound((cust.balance || 0) + totalRefund);
                    }
                } else if(refundMethod === 'split') {
                    // Split: decrease cash/bank, increase customer credit for credit portion
                    if(splitCash > 0) {
        ...
        window.loadPurchaseInvoices = function() {
            ...
            purchases.forEach(t => {
                const invoiceDate = t.purchaseDate ? new Date(t.purchaseDate).toLocaleDateString() : new Date(t.date).toLocaleDateString();
        ...
        window.deletePurchase = function(txnId) {
            ...
            // STEP 1: REMOVE PURCHASED STOCK (delete the batch products created during purchase)
            if(txn.items && Array.isArray(txn.items)) {
                txn.items.forEach(item => {
                    // Find the batch product (the one created during this specific purchase)
                    const prod = db.products.find(p => p.id === item.id);
                    if(prod) {
                        console.log(`✓ Deleting batch product: ${item.qty} units of "${item.name}" (ID: ${item.id}, Ref: ${txn.ref})`);
                        // Remove this batch product from inventory completely
                        db.products = db.products.filter(p => p.id !== item.id);
                    } else {
                        console.warn(`⚠ Batch product not found: ${item.name} (ID: ${item.id})`);
                    }
                });
            }
                    ...
                    <div style="border-bottom: 3px solid #000; padding-bottom: 15px; margin-bottom: 20px;">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 20px;">
                            ...
                            <div style="text-align: center; border-left: 3px solid #000; padding-left: 20px; background: #f9f9f9; padding: 15px 20px; min-width: 220px;">
                                ...
                                <p style="margin: 4px 0; font-size: 11px;">Date: ${new Date(purchaseInvoice.date).toLocaleDateString()}</p>
                            </div>
                        </div>
        ...
        window.runReports = function(type) {
            ...
            if(type === 'balance') {
                ...
                // CRITICAL: Use db.config cash/bank as SOURCE OF TRUTH, not calculated from transactions
                // These are updated in real-time by ALL transactions and are the single source of truth
                ...
                // Calculate assets (stock value + receivables + liquid assets)
                const assets = moneyRound(stockVal + receivables + totalLiquidAssets);
                ...
                tbody.innerHTML += `<tr><td class="p-3">Current Stock (@ Cost)</td><td class="p-3 text-right">${db.config.currency}${stockVal.toFixed(2)}</td></tr>`;
                tbody.innerHTML += `<tr><td class="p-3">Accounts Receivable (Due from Customers)</td><td class="p-3 text-right">${db.config.currency}${receivables.toFixed(2)}</td></tr>`;
                tbody.innerHTML += `<tr><td class="p-3 font-bold">Cash in Hand</td><td class="p-3 text-right font-bold">${db.config.currency}${cashBalance.toFixed(2)}</td></tr>`;
                tbody.innerHTML += `<tr><td class="p-3 font-bold">Bank Balance</td><td class="p-3 text-right font-bold">${db.config.currency}${bankBalance.toFixed(2)}</td></tr>`;
                tbody.innerHTML += `<tr><td class="p-3 font-bold">Total Liquid Assets</td><td class="p-3 text-right font-bold">${db.config.currency}${totalLiquidAssets.toFixed(2)}</td></tr>`;
                tbody.innerHTML += `<tr class="bg-gray-700"><td class="p-3 font-bold">Total Assets</td><td class="p-3 text-right font-bold">${db.config.currency}${assets.toFixed(2)}</td></tr>`;
                tbody.innerHTML += `<tr class="bg-gray-800"><td class="p-3 font-bold" colspan="2">Liabilities</td></tr>`;
                tbody.innerHTML += `<tr><td class="p-3">Accounts Payable (Due to Suppliers)</td><td class="p-3 text-right">${db.config.currency}${payables.toFixed(2)}</td></tr>`;
                tbody.innerHTML += `<tr class="bg-gray-700"><td class="p-3 font-bold">Total Liabilities</td><td class="p-3 text-right font-bold">${db.config.currency}${payables.toFixed(2)}</td></tr>`;
                tbody.innerHTML += `<tr class="bg-green-900"><td class="p-3 font-bold">Equity (Assets - Liabilities)</td><td class="p-3 text-right font-bold text-green-400">${db.config.currency}${equity.toFixed(2)}</td></tr>`;
                return;
            }
            ...
            if(type === 'vat') {
                ...
                const netVat = moneyRound(totalVat - returnTax);
                ...
                cards.innerHTML += createCard('Output VAT Collected', totalVat, 'krata-primary');
                if(returnTax > 0) {
                    cards.innerHTML += createCard('Less: Return VAT', returnTax, 'red-500');
                }
                cards.innerHTML += createCard('NET VAT PAYABLE', netVat, 'green-400');
        ...
        window.updateSettlementAmount = function() {
            ...
            document.getElementById('settlementAmount').max = balanceAmount;
            ...
            return `
                <div style="border: 2px solid #000; padding: 20px; font-family: Arial, sans-serif; color: #000;">
                    ...
                    <div style="border: 2px solid #000; background: #e8e8e8; padding: 12px; margin-bottom: 16px;">
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 12px; font-size: 12px;">
                            <div>
                                ...
                                <p style="margin: 4px 0 0 0; font-size: 14px; font-weight: bold;">${new Date(settlement.date).toLocaleDateString('en-US', { year: 'numeric', month: '2-digit', day: '2-digit' })}</p>
                            </div>
                            <div>
                        ...
                        <div style="border: 2px solid #000; padding: 12px; background: #fff9f0;">
                            ...
                            <table style="width: 100%; font-size: 11px; border-collapse: collapse;">
                                ...
                                <tr style="border-bottom: 1px solid #ddd;">
                                    ...
                                    <td style="padding: 4px 0; text-align: right;">${new Date(settlement.chequeDate).toLocaleDateString()}</td>
                                </tr>
                                ` : ''}
                                ${settlement.bankName ? `
                                <tr style="border-bottom: 1px solid #ddd;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 6px 0; text-align: right; font-weight: bold;">${new Date(settlement.date).toLocaleDateString()}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div style="text-align: center; margin-top: 16px; border-top: 1px solid #ccc; padding-top: 12px; font-size: 10px; color: #666;">
                        ...
                        <p style="margin: 4px 0; font-weight: bold;">Date & Time: ${new Date(settlement.date).toLocaleString()}</p>
        ...
        window.downloadSettlementPDF = function() {
            ...
            doc.setFontSize(10);
            doc.text(`Date: ${new Date(s.date).toLocaleDateString()}`, 14, yPos + 33);
            ...
            doc.save(`Settlement_${s.entityName.replace(/\s+/g, '_')}_${new Date().toISOString().split('T')[0]}.pdf`);
        };
